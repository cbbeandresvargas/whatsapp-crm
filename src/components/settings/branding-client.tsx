        ...
        <CardContent className="space-y-5">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder={process.env.NEXT_PUBLIC_APP_NAME || "WhatsApp CRM"}
              className="max-w-xs"
            />
          </div>
          ...
          <div className="rounded-md border p-4" style={{ background: previewSet.tint }}>
            <div className="flex items-center gap-2.5">
              ...
              >
                {(name.trim() || process.env.NEXT_PUBLIC_APP_NAME || "WhatsApp CRM").charAt(0).toUpperCase()}
              </span>
              <span>
                <span className="block text-[15px] font-[650] leading-tight">
                  {name.trim() || process.env.NEXT_PUBLIC_APP_NAME || "WhatsApp CRM"}
                </span>
